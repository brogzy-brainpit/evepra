...
function TextLanding({preLoaderOut=true}) {
 ...
 const child={
  ...
  <motion.h2 className='text-brand-white break-word text-heading2 leading-[0.95] tracking-[-0.03em] lowercase text-center justify-center font-custom font-black ' initial='initial' exit='exit' animate={preLoaderOut?'animate':'initial'} variants={parent} >
...
<Magnetic >
 ...
 Results       </motion.span>
    {/* <motion.span variants={child} className='mr-[0.2em] inline-block'>Speak </motion.span> */}
    <motion.span variants={child} className='mr-[0.2em] inline-block font-custom2 font-normal leading-[0.5] italic text-[.75em] lortest'>
      speak</motion.span>
