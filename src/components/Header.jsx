...
<div className="flex-1 flex justify-end items-center relative z-20">
     ...
     <AnimatePresence>
      ...
      <motion.div variants={scaleMenu} initial='initial' animate={preLoaderOut?'enter':'initial'} exit={'exit'} ref={scaleMenuIcon}
       onClick={(e)=>{setBurgerMenu(!burgerMenu)}}
        className=" w-[70px] h-[70px] lg:w-[70px] lg:h-70px]  links-cursor flex items-center justify-center ">     
  <motion.div
  ...
  >
    ...
    <motion.h3 className={` z-20 links-cursor flex items-center justify-center bg-orange500 w-full pointer-events-none relative z10 text-[16px] font-custom uppercase font-bold text-center`} animate={{ color: menutextt }}
      transition={{ duration: 0.6, ease: "easeInOut" }}>
