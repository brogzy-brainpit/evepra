...
<div className=' lg:col-start-3 z-10 col-span-full lg:col-span-8 relative h-full w-full flex items-end justify-center pb-[4em] bgslate-500'>
  <motion.h2 className='text-white break-word text-heading2 leading-[0.95] tracking-[-0.03em] lowercase text-center justify-center font-custom font-black ' initial='initial' exit='exit' animate={preLoaderOut?'animate':'initial'} variants={parent} >
...
<Magnetic >
      ...
      make</motion.span>
    <motion.span variants={child} className='mr-[0.2em] inline-block font-custom2 font-normal leading-[0.5] italic text-regular loratest'>advertising</motion.span>
