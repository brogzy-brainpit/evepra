...
import {Lora, DM_Sans, Epilogue} from "next/font/google";
...
const [pageName,setPageName]= useState(router.pathname)
  ...
  return (
    ...
    >
      ...
      >
         <div className='fixed top-0 left-0 w-full h-full z-preloader pointer-events-none'> 
         <div className='absolute w-full h-full inset-0 bg-red50'>
          <svg xmlns="http://www.w3.org/2000/svg" width="100%" 
           viewBox="0 0 3222 3114" fill="none" preserveAspectRatio="none"
            class="text-brand-secondary transition-scribble rotate-180">
        ...
        <motion.h2 className='flex gap-3 capitalize text-white font-custom text-heading2  items-center justify-center'
        animate={{
          opacity:[0,1,1,0],
          y:[20,0,0,-20]
        }}
        ...
        {/* hello wrold */}
        {/* {getTitle(pageName)} */}
        {getTitle(pageName)=='welcome'?<StaggerTextHover className='w-[40vw]'/>
        :<>
