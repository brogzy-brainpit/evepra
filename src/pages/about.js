...
<div className="flex items-center justify-center absolute top-0 left-0 w-full h-screen  z-10">
      ...
      <img src='/assets/brand/03.jpg' className='absolute -rotate-12 top-0 object-cover right-[4%] translate-x-[-30%] h-[15em] md:h-[24em] lg:h-[24em] aspect-[5/7]'/>
      <img src='/assets/brand/01.jpg' className='absolute -rotate-12 bottom-0 object-cover left-[10%] translate-x-[-50%] h-[15em] md:h-[24em] lg:h-[24em] aspect-[5/7]'/>
